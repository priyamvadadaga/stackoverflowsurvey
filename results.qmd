...
Across the four parameters that measure users' perspectives on AI, we observe that although typically polarized views are "sticky", in the sense that those hold strong positive views or strong negative views hold these across their beliefs in accuracy, their sentiment, 
